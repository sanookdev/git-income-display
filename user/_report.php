                ...
                <thead class="text-center">
                    <tr>
                        ...
                        <th style="color:green;">
                            ค่าตอบแทนเพื่อเพิ่มประสิทธิภาพและค่าตอบแทนเพื่อการเพิ่มประสิทธิภาพพิเศษ
                        </th><!-- VAL = 5 -->
                        ...
                        <th style="color:green;">ค่า พ.ต.ส.</th> <!-- VAL = 10 -->
            ...
            success: function(data) {
                ...
                for (i = 0; i < parseInt(month); i++) {
                    ...
                    data_other[((i) < 9 ? '0' + parseInt(i + 1) : parseInt(i + 1))] = {
                        ...
                        "14": "",
                        "month": m.toString(),
                        "year": (year == null) ? d.getFullYear().toString() : year.toString(),
                    }
                }
                ...
                if ((Object.keys(data_other).length > 0)) {
                    for (i = 0; i < Object.keys(data_other).length; i++) {
                        ...
                        output += '<td>' +
                            ...
                            my_data['month'] + ',' + ((my_data['year'] != null && my_data['year'] !=
